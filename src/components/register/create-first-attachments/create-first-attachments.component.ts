...
@Component({
  selector: 'app-create-first-attachments',
  standalone: true,
  imports: [NgOptimizedImage, ReactiveFormsModule],
  templateUrl: './create-first-attachments.component.html',
  styleUrl: './create-first-attachments.component.scss',
})
export class CreateFirstAttachmentsComponent implements OnInit {
  constructor(
  ...
  addDocuments() {
    this.router.navigateByUrl('/register/set-project-goals');
  }
  ngOnInit(): void {
    if (typeof window !== 'undefined') {
      let project_id: any = localStorage.getItem('project_id');
