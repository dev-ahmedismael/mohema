...
@Component({
  selector: 'app-create-project-goals',
  standalone: true,
  imports: [ReactiveFormsModule, CommonModule, NgOptimizedImage],
  templateUrl: './create-project-goals.component.html',
  styleUrl: './create-project-goals.component.scss',
})
export class CreateProjectGoalsComponent {
  constructor(
